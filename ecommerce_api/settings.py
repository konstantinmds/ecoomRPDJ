...
DEFAULT_FILE_STORAGE = 'ecommerce_api.azure_function.AzureMediaStorage'
STATICFILES_STORAGE = 'ecommerce_api.azure_function.AzureStaticStorage'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'djangoaccountstorage1', 'static')
]
